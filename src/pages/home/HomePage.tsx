            ...
            <article className="panel">
                <div>
                    ...
                    <p className="panel__description">
                        Datos mockeados desde JSONPlaceholder. Al seleccionar un
                        item se construye un recurso compatible con MCP-UI.
                    </p>
                </div>
                <PostList
                    posts={posts}
            ...
            <article className="panel">
                <div>
                    ...
                    <p className="panel__description">
                        ...
                        <code>UIResourceRenderer</code> del SDK de MCP-UI.
                    </p>
                </div>
                ...
                {remoteDomResource ? (
                    <section>
                        ...
                        <p className="panel__description">
                            El recurso utiliza el modo{" "}
                            <code>remote-dom</code> del SDK de MCP-UI para renderizar
                            componentes directamente mediante JavaScript en un contexto sandboxed.
                        </p>
                        <ResourceViewer
